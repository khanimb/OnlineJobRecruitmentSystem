...
namespace OnlineJobRecruitmentSystem.Application.Validations.JobSeekerDtoValidation
{
    public class UpdateJobSeekerDtoValidation : AbstractValidator<UpdateJobSeekerDto>
    {
        public UpdateJobSeekerDtoValidation()
        {
